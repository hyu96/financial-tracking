  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#F8FAFC' }}>
      <div className="bg-white rounded-2xl shadow-lg p-10 flex flex-col items-center gap-6 w-full max-w-sm">
        <div className="w-12 h-12 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#CA8A04' }}>
        ...
        <div className="text-center">
          <h1 className="text-xl font-bold text-slate-900">Financial Tracker</h1>
          <p className="text-sm text-slate-500 mt-1">Personal investment overview</p>
        </div>
        <button
          onClick={signIn}
